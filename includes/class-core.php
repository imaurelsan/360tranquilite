...
class TRQ_Core {
    ...
    private static array $defaults = [
        ...
        'media_optimization_max_width' => 2560,
        'media_optimization_max_height' => 2560,
        ...
        'toolkit_admin_menu_width' => 160,
        'toolkit_admin_menu_cleanup_enabled' => false,
        'toolkit_admin_menu_hidden_slugs' => '',
        'toolkit_admin_menu_reorder_enabled' => false,
        'toolkit_admin_menu_order' => '',
        'toolkit_admin_footer_text_enabled' => false,
        'toolkit_admin_footer_text' => '',
        'toolkit_admin_bar_cleanup_enabled' => false,
        'toolkit_admin_bar_remove_wp_logo' => false,
        'toolkit_admin_bar_remove_comments' => false,
        'toolkit_admin_bar_remove_new_content' => false,
        'toolkit_admin_bar_remove_updates' => false,
        ...
        'toolkit_taxonomy_filters_post_types' => 'post,page',
        'toolkit_taxonomy_terms_order_enabled' => false,
        'toolkit_taxonomy_terms_orderby' => 'name',
        'toolkit_taxonomy_terms_order' => 'ASC',
        ...
        'toolkit_staging_patterns' => 'staging.,dev.,localhost,.local,.test',
